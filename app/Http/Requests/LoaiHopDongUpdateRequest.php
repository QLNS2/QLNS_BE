...
class LoaiHopDongUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'ten_hop_dong'  => 'required|min:6|max:100|unique:loai_hop_dongs,ten_hop_dong,' . $this->id,
    ...
    {
        return [
            'id.required'           => 'Loại hợp đồng cần cập nhật không được để trống!',
            'id.exists'             => 'Loại hợp đồng cần cập nhật không tồn tại!',
