...
class ThuongVaPhatUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'id.required'           => 'Thưởng và phạt cần cập nhật không được để trống!',
            'id.exists'             => 'Thưởng và phạt cần cập nhật không tồn tại!',
